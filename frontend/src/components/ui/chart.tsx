...
// Simplified payload type for tooltip
...
// Simplified payload type for legend
...
function getPayloadConfigFromPayload(config: ChartConfig, payload: unknown, key: string) {
  ...
  const payloadPayload =
    payload && typeof payload === "object" && "payload" in payload && typeof payload.payload === "object" && payload.payload !== null
      ? payload.payload
      : undefined;

  let configLabelKey: string = key;

  if (payload && typeof payload === "object" && key in payload && typeof (payload as any)[key] === "string") {
